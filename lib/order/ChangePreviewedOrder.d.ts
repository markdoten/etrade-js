import type { ICashBuyingPowerDetails, IDisclosure, IDtBuyingPowerDetails, IMarginBuyingPowerDetails, IOrderDetail, IOrderDetailReq, IPreviewId } from './interfaces';
...
/**
 * @see {@link https://apisb.etrade.com/docs/api/order/api-order-v1.html#/definitions/PreviewOrderResponse|PreviewOrderResponse Docs}
 */
...
declare const _default: ({ accountIdKey, orderId, ...PreviewOrderRequest }: IChangePreviewedOrderRequest) => Promise<IChangePreviewedOrderResponse>;
/**
