 ...
 * @file Order enums.
 */
export { MarketSession } from '@src/enums';
export declare enum CashMargin {
    CASH = "CASH",
    MARGIN = "MARGIN"
}
export declare enum ConditionFollowPrice {
    ASK = "ASK",
    BID = "BID",
    LAST = "LAST"
}
...
export declare enum MarginLevel {
...
export declare enum MFTransaction {
    BUY = "BUY",
    SELL = "SELL"
}
...
export declare enum PositionQuantity {
    CASH = "CASH",
    ENTIRE_POSITION = "ENTIRE_POSITION",
    MARGIN = "MARGIN"
}
export declare enum ReInvestOption {
...
export declare enum RoutingDestination {
    AMEX = "AMEX",
    AUTO = "AUTO",
    BOX = "BOX",
    CBOE = "CBOE",
