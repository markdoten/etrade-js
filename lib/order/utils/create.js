 ...
 */
const createOrder = ({ accountId, allOrNone = false, orderAction = enums_2.OrderAction.BUY, orderTerm = enums_2.OrderTerm.GOOD_FOR_DAY, override, priceType = enums_2.OrderPriceType.MARKET, quantity, securityType = enums_1.SecurityType.EQ, symbol }) => (Object.assign({ accountId,
